...
$('#orcamento_seg_car_terceiros_50k').click(function() {
  if($(this).is(':checked')){
    $('#seguro_final').val($('#seguro_final').val() + 2)
...
$('#orcamento_seg_car_reserva_7d_true').change(function() {
  if($(this).on('select')){
    console.log('7d select')
    $(dl5).val(parseFloat($(dl5).val())  + 10)
    parseFloat($('#seguro_final').text($(dl5).val() )).toFixed(2); 
...
$('#orcamento_seg_car_reserva14_true').change(function() {
  if($(this).checked){
    console.log('14 d check')
    $(dl5).val(parseFloat($(dl5).val())  + 14)
    parseFloat($('#seguro_final').text($(dl5).val() )).toFixed(2); 

  } $(this).bind('deselect', function(){
    console.log('14 d uncheck')
    $(dl5).val(parseFloat($(dl5).val()) - 14)
    parseFloat($('#seguro_final').text($(dl5).val() )).toFixed(2); 
    })
